...
# NX_VALUES = (150,)
# NX_VALUES = (90, 120, 150, 180, 360, 720, 1440, 2000, 2880)
NX_VALUES = (120, 150, 180)
CFL = 0.5
VP = 3957.419
T_TOTAL_S = 1.2
CONTACT_Z_M = 3000.0
DOMAIN_SIZE_Z_M = CONTACT_Z_M*2
SPECTRAL_POLYNOMIAL_DEGREE = 4
TIMING_PROJECT_SUFFIX = "_timing"
RECEIVER_OFFSET_M = 500.0

DOMAIN_SIZE_X_M = DOMAIN_SIZE_Z_M
SOURCE_X_M = 3000
SOURCE_Z_M = 2000
RECEIVERS = (
    ...
    {"name": "station_6", "x": SOURCE_X_M - 2*RECEIVER_OFFSET_M, "z": CONTACT_Z_M + RECEIVER_OFFSET_M},
    {"name": "station_7", "x": SOURCE_X_M -   RECEIVER_OFFSET_M, "z": CONTACT_Z_M + RECEIVER_OFFSET_M},
    {"name": "station_8", "x": SOURCE_X_M                      , "z": CONTACT_Z_M + RECEIVER_OFFSET_M},
    {"name": "station_9", "x": SOURCE_X_M +   RECEIVER_OFFSET_M, "z": CONTACT_Z_M + RECEIVER_OFFSET_M},
    {"name": "station_10", "x": SOURCE_X_M + 2*RECEIVER_OFFSET_M, "z": CONTACT_Z_M + RECEIVER_OFFSET_M},
)
