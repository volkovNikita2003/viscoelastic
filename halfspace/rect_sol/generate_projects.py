...
RECEIVERS = (
    {"name": "station_1", "coord_m": SOURCE_COORD_M + [-2*RECEIVER_OFFSET_M, RECEIVER_OFFSET_M]},
    {"name": "station_2", "coord_m": SOURCE_COORD_M + [-RECEIVER_OFFSET_M, RECEIVER_OFFSET_M]},
    {"name": "station_3", "coord_m": SOURCE_COORD_M + [0.0, RECEIVER_OFFSET_M]},
    {"name": "station_4", "coord_m": SOURCE_COORD_M + [RECEIVER_OFFSET_M, RECEIVER_OFFSET_M]},
    {"name": "station_5", "coord_m": SOURCE_COORD_M + [2*RECEIVER_OFFSET_M, RECEIVER_OFFSET_M]},
)
...
def get_case_params(nx):
    ...
    params["force_coef"] = 1/(RHO*grid_spacing[0]*grid_spacing[1])
