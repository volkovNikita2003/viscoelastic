...
echo
echo "Полная очистка проекта Komatitsch 1999"
"$SCRIPT_DIR/clean_all.sh"

CURRENT_STAGE="квазианалитические решения"
echo
echo "Запуск всех квазианалитических расчётов"
"$SCRIPT_DIR/analytical_sol/run_all.sh"
...
echo
echo "Все этапы проекта Komatitsch 1999 успешно завершены"
